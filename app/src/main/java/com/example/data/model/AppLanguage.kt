...
val EnglishAppStrings = AppStringsData(
    ...
    secFeaturedFellowship = "FEATURED FELLOWSHIP EVENT",
    secRecentFellowship = "RECENT FELLOWSHIP EVENTS",
    secFavoritesFirst = "FELLOWSHIP EVENTS (FAVORITES FIRST)",
    secLatestVideos = "▶️ LATEST VIDEOS",
    ...
    secPersonalVlog = "PERSONAL VLOG",
    viewAll = "View All",
    exploreYouTube = "Explore YouTube",
    allPlaylists = "All Playlists",
    albums = "Albums",
    readChapter = "Read Chapter",
    allVlogPosts = "All Vlog Posts",
    ...
    upcomingEventsSub = "Fellowship events detected from Blogger feed",
...
val HindiAppStrings = AppStringsData(
    ...
    secFeaturedFellowship = "विशेष संगति कार्यक्रम",
    secRecentFellowship = "हालिया संगति कार्यक्रम",
    secFavoritesFirst = "संगति कार्यक्रम (पसंदीदा पहले)",
    secLatestVideos = "▶️ नवीनतम वीडियो",
    ...
    upcomingEventsSub = "ब्लॉगर फ़ीड से पहचाने गए संगति कार्यक्रम",
    ...
    blogsTitle = "संगति ब्लॉग्स",
    searchBlogsPlaceholder = "लेख, कार्यक्रम खोजें...",
    filterAll = "सभी",
    filterFellowship = "संगति",
    filterVlog = "व्यक्तिगत व्लॉग",
